...
Usage:
  python3 bootstrap/record_event.py --type file_edit --file tower-defense.html --desc "Fixed spawnDelay bug"
  python3 bootstrap/record_event.py --type file_create --file new_file.js --desc "Created new component"
  python3 bootstrap/record_event.py --type note --desc "Decision: use array for wave enemies"
